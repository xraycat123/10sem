#################################################################################
# usage of the script
# usage: python searchTerms.py -k APIKEY -v VERSION -s STRING
...
apikey = '3a3ef93e-339f-4b99-bfba-246a68ce5095'#args.apikey
version = 'current'#args.version

print("assds")
#string = 'diabetes'#args.string
...
def metode(searchTerm):
    ...
    while pageNumber==0:
        ...
        pageNumber += 1
        query = {'string':searchTerm,'ticket':ticket, 'pageNumber':pageNumber}
        #query['includeObsolete'] = 'true'
        #query['includeSuppressible'] = 'true'
        query['returnIdType'] = "code"
        query['sabs'] = "SNOMEDCT_US"
        query['pageSize']="1"
        #query['searchType'] = "approximate"
